    ...
    // var wellcome = "Well Come Our Website"; 
    // alert(wellcome);
    ...
    // var userName;    
    // var myName = "Haris Shah";
    // var age = 23;
    // var student = "Web & App";
    // var bioData = myName + age + student;
    // var message = "Hello World";
    // alert(message);
    // alert(bioData);
    // alert("My Name is" + " " + myName + " " + "& i'm" + " " + age + " " + "old");

    // var email = "shahhariss946@gmail.com"
    ...
    // var number = 14;
    // document.write("You have visited this site" + " " + number + " " + "times");
    ...
    // document.write("My birth year is " + " " + birthYear);
      ...
      // var productTitle = "www.xyzClothing.com"
      // var quantity = 5;
      // document.write(VisitorName + " " + "Ordered" + " " + quantity + " " + "T-shirts" + " " + "on" + " " + productTitle);


                  // Chapter # 04

  // var stat1 = "Hello World";
  // var stat2 = "Hello World";
  // var stat3 = 42;
...
// alert("The multiplication of two number " + num1 + " and " + num2 + " is " + resultt)
...
// var num2 = +prompt("Enter second number")
// var resultt = num1 / num2
// alert("The division of two number " + num1 + " and " + num2 + " is " + result)
...
// var num2 = +prompt("Enter second number")
// var resultt = num1 % num2
// alert("The modulus of two number " + num1 + " and " + num2 + " is " + resultt)
